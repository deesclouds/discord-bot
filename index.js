...
client.on('interactionCreate', async interaction => {
    if (interaction.commandName === 'ping') {
        ...
        interaction.reply({
            content: `Ok you said ${dasy} and ${washy}`,
            ephemeral: true
        })
    }
})
...
// Moderation Commands
    ...
    if (cmd === `${prefix}ban`) {
		...
		if (!message.guild.me.permissions.has('BAN_MEMBERS')) return message.reply('You do no have permission to ban members from this server!');
